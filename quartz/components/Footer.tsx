  ...
  const Footer: QuartzComponent = ({ displayClass }: QuartzComponentProps) => {
    ...
    return (
      <footer class={`${displayClass ?? ""}`}>
        <p>
          Nancy Drew Database created using {" "}
          <a href="https://quartz.jzhao.xyz/">Quartz v{version}</a> © {year}
        </p>
        <ul>
          <li>
            {/**Github */}
            <a href="https://github.com/nancydrewdatabase/nancydrewdatabase.github.io" target="_blank" class="text-decoration-none">
          ...
          <li>
          {/**Bug*/}
            <a href="https://forms.gle/66uHphUFshhBF3Hp8" target="_blank" class="text-decoration-none">
